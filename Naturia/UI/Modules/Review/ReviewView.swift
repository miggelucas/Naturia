    ...
    var body: some View {
        ZStack {
            ...
            VStack (spacing: 36){
                ...
                TextAndConfirmationButtons(cardType: .grande, firstLine: "Parabéns, olha o quanto você aprendeu!", secondLine: "Quer saber mais sobre \(viewModel.nameOfPlant)?", firstButtonType: .sim, secondButtonType: .agoranao, actionForGreenButton: {
